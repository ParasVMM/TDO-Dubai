jQuery(function ($) {
    ...
    $('body').append("<div class='switch-box d-none'><label id='switch' class='switch'><input type='checkbox' onchange='toggleTheme()' id='slider'><span class='slider round'></span></label></div>");
    try {
