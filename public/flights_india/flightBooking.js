...
async function loadFlightDetails() {
    ...
    grossFare = arr.Segments[0].FareBreakup.Api_PublishedFare;
...
<span
    ...
    if(fareBreakupResponse.ResponseStatus === 1)
    {
        ...
        let TBOFareCard = new TBOFareBreakupCard(fareBreakupResponse.response.response, 0,arr.Segments[0].FareBreakup.Agent_Markup,arr.Segments[0].FareBreakup.TDO_Markup);
...
async function ConfirmBookingFlight() {
    console.log(arr.Segments[0].FareBreakup.Agent_Markup)
    paxArray =  [];
    if ($("#details").valid()) {
...
`,
        ...
        if(paxArray.length > 0){
            ...
            let bookingData = {
                ...
                supplier :  "RIYA",
                agent_amount : totalAmount - arr.Segments[0].FareBreakup.Agent_Markup,
            ...
            fd.append('total', totalAmount - arr.Segments[0].FareBreakup.Agent_Markup);
