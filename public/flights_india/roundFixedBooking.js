    ...
    flight = [
        {
            ...
            "GrossFare": arr.onwardFlight.Segments[0].FareBreakup.Api_PublishedFare,
            "segments": segmentOn
        },
        {
            ...
            "GrossFare": arr.returnFlight.Segments[0].FareBreakup.Api_PublishedFare,
            "segments": segmentRe
        }
    ]
        ...
        try {
            ...
            if (fareResponse.ResponseStatus === 1) {
                ...
                if (fareResponse.ResponseStatus === 1) {
                    ...
                    let TBOFareCard = new TBOFareBreakupCardFixed(fareArray, 0,arr.onwardFlight.Segments[0].FareBreakup.Agent_Markup,arr.onwardFlight.Segments[0].FareBreakup.TDO_Markup);
        ...
        if(arr.Custom === 'Yes'){
            if(paxArray.length > 0){
                ...
                let bookingData = {
                    ...
                    supplier :  "RIYA",
                    agent_amount : totalAmount - (arr.onwardFlight.Segments[0].FareBreakup.Agent_Markup + arr.returnFlight.Segments[0].FareBreakup.Agent_Markup),
                ...
                fd.append("email",document.getElementById(`leademail`).value);
                fd.append("mobile",document.getElementById(`mobile`).value);
                fd.append('total', totalAmount- (arr.onwardFlight.Segments[0].FareBreakup.Agent_Markup + arr.returnFlight.Segments[0].FareBreakup.Agent_Markup));
                fd.append("hold", fareResponse.response.response.HoldAvailable);
                fd.append("revised", fareResponse.response.response.Isfarerevised);
                fd.append("totalAdult", arr.onwardFlight.adults);
                fd.append("totalChild", arr.onwardFlight.childs);
