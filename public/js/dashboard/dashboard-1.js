let showChart = (charType) => {
    ...
    if (charType === "weekly") {
        ...
        fetch("/fetchChartCount", {
            ...
            // console.log(amtArr)
            document.getElementById("totalAmt1").innerText = sum.toFixed(2) + " (Weekly)"
        ...
        fetch("/fetchChartCount",{
            ...
            // console.log(amtArr)
            document.getElementById("totalAmt1").innerText = sum.toFixed(2) + " (Monthly)"
            var dzChartlist = function () {
                var screenWidth = $(window).width();
                let draw = Chart.controllers.line.__super__.draw; //draw shadow
                var activityz = function () {
        ...
        fetch("/fetchChartCount",{
            ...
            // console.log(amtArr)
            document.getElementById("totalAmt1").innerText = sum.toFixed(2) + " (Yearly)"
            var dzChartlist = function () {
                var screenWidth = $(window).width();
                let draw = Chart.controllers.line.__super__.draw; //draw shadow
                var activityz = function () {
