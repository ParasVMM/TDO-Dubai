(function ($) {
	...
	(function () {
		...
		roomAddBtn.addEventListener('click', function () {
			roomCount = addValues1(roomCount);
			updateValues();
		});
		...
		function addValues1(count) {
			return (calcTotalGuests1() < maxNumGuests1) ? count + 1 : count;
		}
		...
		function updateValues() {
			...
			btnText += (roomCount > 0) ? `, ${roomCount} Infants` : '';
